$(function(){
    ...
    //usar essas duas funções para desabilitar o select do mouse, que impedi de clickar novamente no cursor
    ...
    // mini img wraper style="background-color: rgb(211, 209, 209);" foto destaque background img
    ...
    /// a funcção abaixo serve para que ao clicar na image ela mude a cor da borda e apareça na caixa de seleção
